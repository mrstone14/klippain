...
```bash
wget -O - https://raw.githubusercontent.com/mrstone14/klippain/develop/install.sh | bash
```
...
```bash
wget -O - https://raw.githubusercontent.com/mrstone14/klippain/develop/uninstall.sh | bash
```
