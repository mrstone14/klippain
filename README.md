...
```bash
wget -O - https://raw.githubusercontent.com/mrstone14/klippain/LED_effects_rework/install.sh | bash
```
...
```bash
wget -O - https://raw.githubusercontent.com/mrstone14/klippain/LED_effects_rework/uninstall.sh | bash
```
