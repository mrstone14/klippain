...
```bash
wget -O - https://raw.githubusercontent.com/mrstone14/klippain/main/install.sh | bash
```
...
```bash
wget -O - https://raw.githubusercontent.com/mrstone14/klippain/main/uninstall.sh | bash
```
